...
public class Crab extends GameCharacter implements Dangerous, Updatable {

	public Crab(Room room) { super(room); }

	@Override public String getName() { return "krab"; }
	@Override public int getLayer() { return 2; }
	@Override public boolean isSmall() { return true; }
	@Override public boolean isEnemy() { return true; }
	
	// CORREÇÃO: Assinatura atualizada
	@Override public int getPushLimit(Direction dir) { return 0; }
	@Override public boolean canPushHeavy() { return false; }
	@Override public int getSupportLimit() { return 0; }
	@Override public boolean canSupportHeavy() { return false; }
